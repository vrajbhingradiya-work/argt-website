...
function Clients() {
  return (
    <div
      id="clients"
      className=" text-dark-blue py-16 px-16 xl:p-0 xl:py-12 flex flex-col  w-full justify-center items-center bg-white h-auto "
    >
...
function ClientCard({ client }: any) {
  return (
    <div className="relative flex justify-center items-center">
      <div className="relative w-[150px] flex justify-center items-center ">
