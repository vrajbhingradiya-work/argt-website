          ...
          <div className="flex justify-center items-center w-full">
            {loading ? (
              ...
              <button
                ...
                type="submit"
                className="py-3 px-5 text-xl font-medium text-center text-dark-blue hover:text-white tracking-wider  bg-secondary sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 transition hover:ease-in-out duration-300  dark:hover:bg-dark-blue dark:focus:ring-primary-800"
              >
                SEND MESSAGE
              </button>
            )}
