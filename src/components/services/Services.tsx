...
function Services() {
  ...
  return (
    <div className="w-full flex justify-center items-center bg-[#F5F6F7] py-16">
      <div className="w-full xl:max-w-[1200px] flex flex-col gap-8 py-12 items-center justify-center">
...
function ServiceCard({ service }: any) {
  return (
    <div className="relative ">
      ...
      <div className="absolute group flex flex-col items-center justify-center bg-black/50 w-[400px] h-full top-0 left-0">
